...
<div class="container-fluid">
	<div class="col-lg-12">
		<div class="card">
            ...
            <select name="statusevent" id="" class="custom-select">
                <option value="0" <?php echo isset($statusevent) && $statusevent == 0 ? "selected" : '' ?>>For Verification</option>
                <option value="1" <?php echo isset($statusevent) && $statusevent == 1 ? "selected" : '' ?>>Confirmed</option>
                <option value="2" <?php echo isset($statusevent) && $statusevent == 2 ? "selected" : '' ?>>Cancelled</option>
            </select>
        </div>
					</div>
					<div class="form-group row">
