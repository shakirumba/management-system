			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						<b>List of Events</b>
						<span class="float:right"><a class="btn btn-primary btn-block btn-sm col-sm-2 float-right" href="index.php?page=manage_eventstaff" id="new_event">
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										 <?php if($row['statusevent'] == 0): ?>
										 	<span class="badge badge-secondary">For Verification</span>
										 <?php elseif($row['statusevent'] == 1): ?>
										 	<span class="badge badge-primary">Confirmed</span>
										<?php elseif($row['statusevent'] == 2): ?>
